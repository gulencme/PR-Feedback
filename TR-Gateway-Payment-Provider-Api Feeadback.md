...
- **Açıklama:** Reporting endpoint'lerinin ayrı bir API olarak mı yoksa mevcut API spec'e eklenmiş olarak mı tutulacağına dair karar bekleniyor.
